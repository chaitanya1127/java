public class variable {
	...
	public static void main(String[] args) {
		byte numberOfEmployeesInRoom = 18;
		byte departmentId = 27;
		byte numberOfDepartmentsInCollege = 30;
		byte vowelsInAnAlpthabets = 5;
		byte colorsInTrafficSignal = 3;
		byte priceOfBook = 40;
		byte workingHoursPerDay = 9;
		byte buildingsInColony = 30;
		...
		short numberOfStudentsInClass = 120;
		short numberOfSystemsWorkingInLab = 11;
		short productCode = 6847 ;
		short costOfBag = 700;
		short workersInIndustry = 48;
		short numberOfBooksInRack = 50;
		short countOfSwitchesInBoard = 6;
